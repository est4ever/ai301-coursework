...
I am most comfortable with Python and have experience with AI/ML, robotics, and software development. I prefer issues involving Python, APIs, data processing, debugging, or machine-learning-related code. I am also comfortable learning unfamiliar codebases when the issue is clearly scoped. I would prefer to avoid issues that require deep expertise in unfamiliar low-level systems or very large architectural changes.
